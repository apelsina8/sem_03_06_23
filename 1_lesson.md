...
### git config --global user.name "Kirill Ognev" 
### git config --global user.email "kirillognev@gmail.com"
...
# 
## 13. Отображение журнала фиксации в виде графика для текущей или всех веток
...
#
## 14. Прекращение слияния при конфликте
